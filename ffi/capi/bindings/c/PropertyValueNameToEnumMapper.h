...
typedef struct icu4x_PropertyValueNameToEnumMapper_load_vertical_orientation_mv1_result {union {PropertyValueNameToEnumMapper* ok; DataError err;}; bool is_ok;} icu4x_PropertyValueNameToEnumMapper_load_vertical_orientation_mv1_result;
icu4x_PropertyValueNameToEnumMapper_load_vertical_orientation_mv1_result icu4x_PropertyValueNameToEnumMapper_load_vertical_orientation_mv1(const DataProvider* provider);
