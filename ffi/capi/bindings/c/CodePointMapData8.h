...
typedef struct icu4x_CodePointMapData8_load_vertical_orientation_mv1_result {union {CodePointMapData8* ok; DataError err;}; bool is_ok;} icu4x_CodePointMapData8_load_vertical_orientation_mv1_result;
icu4x_CodePointMapData8_load_vertical_orientation_mv1_result icu4x_CodePointMapData8_load_vertical_orientation_mv1(const DataProvider* provider);
