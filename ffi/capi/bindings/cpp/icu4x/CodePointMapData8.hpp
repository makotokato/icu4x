...
namespace capi {
    ...
    typedef struct icu4x_CodePointMapData8_load_vertical_orientation_mv1_result {union {icu4x::capi::CodePointMapData8* ok; icu4x::capi::DataError err;}; bool is_ok;} icu4x_CodePointMapData8_load_vertical_orientation_mv1_result;
    icu4x_CodePointMapData8_load_vertical_orientation_mv1_result icu4x_CodePointMapData8_load_vertical_orientation_mv1(const icu4x::capi::DataProvider* provider);
...
inline diplomat::result<std::unique_ptr<icu4x::CodePointMapData8>, icu4x::DataError> icu4x::CodePointMapData8::load_vertical_orientation(const icu4x::DataProvider& provider) {
  auto result = icu4x::capi::icu4x_CodePointMapData8_load_vertical_orientation_mv1(provider.AsFFI());
  return result.is_ok ? diplomat::result<std::unique_ptr<icu4x::CodePointMapData8>, icu4x::DataError>(diplomat::Ok<std::unique_ptr<icu4x::CodePointMapData8>>(std::unique_ptr<icu4x::CodePointMapData8>(icu4x::CodePointMapData8::FromFFI(result.ok)))) : diplomat::result<std::unique_ptr<icu4x::CodePointMapData8>, icu4x::DataError>(diplomat::Err<icu4x::DataError>(icu4x::DataError::FromFFI(result.err)));
}
